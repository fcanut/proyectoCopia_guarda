// Obtener el botón
const openPopupBtn = document.getElementById("button-regresar");
...
openPopupBtn.addEventListener("click", () => {
  ...
  const popupWindow = window.open("inicio-sesion.html", "PopupWindow", `width=${popupWidth},height=${popupHeight},left=${leftPosition},top=${topPosition}`);
});